...
import net.kender.io.ExceptionTriConsumer;
import net.kender.io.MaxDepthIO;
import net.kender.nbt.tag.ByteArrayTag;
import net.kender.nbt.tag.ByteTag;
import net.kender.nbt.tag.CompoundTag;
import net.kender.nbt.tag.DoubleTag;
import net.kender.nbt.tag.EndTag;
import net.kender.nbt.tag.FloatTag;
import net.kender.nbt.tag.IntArrayTag;
import net.kender.nbt.tag.IntTag;
import net.kender.nbt.tag.ListTag;
import net.kender.nbt.tag.LongArrayTag;
import net.kender.nbt.tag.LongTag;
import net.kender.nbt.tag.ShortTag;
